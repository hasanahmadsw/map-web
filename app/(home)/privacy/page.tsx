...
import { generatePrivacyPolicyPageSchema } from '@/utils/seo/schema/legal/privacy-policy-page-schema';
...
export default async function PrivacyPage() {
  const jsonLd = await generatePrivacyPolicyPageSchema();
        ...
        <div className="prose prose-neutral dark:prose-invert">
          ...
          <section className="mt-8 space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              and project details when you contact us or request a quote. We may also collect usage data when
          ...
          <section className="mt-8 space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              We use the information we collect to respond to your enquiries, provide our services, improve
              our website, and communicate with you about our services. We do not sell your personal
          ...
          <section className="mt-8 space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              We implement appropriate security measures to protect your personal information. We retain your
              data only for as long as necessary to fulfil the purposes outlined in this policy.
            </p>
          </section>

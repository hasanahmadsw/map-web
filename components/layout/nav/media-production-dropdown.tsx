...
interface MediaProductionDropdownProps {
  onLinkClick?: () => void;
}

export function MediaProductionDropdown({ onLinkClick }: MediaProductionDropdownProps) {
  ...
  // Show first 5 services in dropdown

    ...
    <section className="section-padding container">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
        {coreValues.map((value, index) => (
          ...
          >
            <Card className="group relative transform overflow-hidden border-none bg-linear-to-br from-white to-blue-50/30 shadow-lg transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl">
              {/* Background decorative elements */}
              <div className="absolute top-1/2 left-1/4 h-12 w-12 rounded-full bg-[radial-gradient(circle,var(--secondary)/30,transparent_70%)] opacity-20" />
              <div className="absolute right-1/4 bottom-4 h-8 w-8 rounded-full bg-[radial-gradient(circle,var(--secondary)/30,transparent_70%)] opacity-20" />
              ...
              <CardContent className="relative p-8 text-center">
                ...
                <div className="relative mb-8">
                  <div className="from-primary/10 to-primary/20 mx-auto flex h-20 w-20 items-center justify-center rounded-2xl bg-linear-to-br shadow-lg transition-transform duration-500 group-hover:scale-110 group-hover:shadow-xl">
                ...
                {/* Decorative element */}
                <div className="via-primary/30 absolute bottom-0 left-1/2 h-1 w-16 -translate-x-1/2 transform bg-linear-to-r from-transparent to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
              </CardContent>
            </Card>
          </MotionWrapper>
        ))}

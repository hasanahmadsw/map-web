    ...
    <section className="bg-muted/30 py-16 lg:py-24">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          >
            <Card className="group relative h-full transform overflow-hidden border-none bg-gradient-to-br from-white to-blue-50/30 shadow-lg transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl">
              {/* Background decorative elements */}
              <div className="from-primary/15 to-secondary/15 absolute top-0 right-0 h-32 w-32 translate-x-16 -translate-y-16 rounded-full bg-gradient-to-br transition-transform duration-700 group-hover:scale-110" />
              <div className="from-primary/15 to-secondary/15 absolute bottom-0 left-0 h-24 w-24 -translate-x-12 translate-y-12 rounded-full bg-gradient-to-tr transition-transform duration-700 group-hover:scale-110" />

              {/* Additional background elements for better visibility */}
              <div className="absolute top-1/2 left-1/4 h-24 w-24 rounded-full bg-[radial-gradient(circle,_var(--secondary)/30,transparent_70%)] opacity-20" />
              <div className="absolute right-1/4 bottom-8 h-16 w-16 rounded-full bg-[radial-gradient(circle,_var(--secondary)/30,transparent_70%)] opacity-20" />
              ...
              <CardContent className="relative flex h-full flex-col p-6">
                ...
                <div className="mb-6 flex items-start gap-4">
                  <div className="relative flex-shrink-0">
                    <div className="from-primary/10 to-secondary/20 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br shadow-lg transition-transform duration-500 group-hover:scale-110 group-hover:shadow-xl">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="from-primary to-secondary h-1 w-12 rounded-full bg-gradient-to-r opacity-60 transition-opacity duration-300 group-hover:opacity-100" />
                  </div>
                </div>
              ...
              <CardContent className="relative flex h-full flex-col p-6">
                ...
                <div className="flex flex-1 flex-col justify-center">
                  <p className="mb-4 text-base leading-relaxed text-gray-600 transition-colors duration-300 group-hover:text-gray-700">
                    ...
                    the wider Middle East, known for our creative excellence and innovation. We aim to
                    inspire, inform, and engage audiences through impactful visual content that resonates with

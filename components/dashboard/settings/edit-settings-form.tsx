    ...
    <div className="space-y-6">
      <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center gap-2">
                  {formData.siteLogo && (
                    <div className="relative h-20 w-20 overflow-hidden rounded-lg border">
                      <img src={formData.siteLogo} alt="Logo" className="h-full w-full object-cover" />
                      <Button
                        type="button"
                        variant="destructive"
                        size="sm"
                ...
                <div className="flex items-center gap-2">
                  {formData.siteFavicon && (
                    <div className="relative h-16 w-16 overflow-hidden rounded-lg border">
                      <img src={formData.siteFavicon} alt="Favicon" className="h-full w-full object-cover" />
                      <Button
                        type="button"
                        variant="destructive"
                        size="sm"
        ...
        <MediaPickerDialog
          ...
          filter="image"
          initialSelected={
            mediaPickerType === 'logo' && formData.siteLogo
              ? [formData.siteLogo]
              : mediaPickerType === 'darkLogo' && formData.siteDarkLogo
                ? [formData.siteDarkLogo]
                : mediaPickerType === 'favicon' && formData.siteFavicon
                  ? [formData.siteFavicon]
                  : []
          }
        />
